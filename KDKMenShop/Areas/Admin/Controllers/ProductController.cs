...
namespace KDKMenShop.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.SanPhams.Include(sp => sp.MaVatLieuNavigation).OrderByDescending(p => p.MaSanPham).ToListAsync());
        }
        [HttpGet]
        ...
        public IActionResult Create()
        {
            ...
            @ViewBag.admin = HttpContext.Session.GetString("User");
			ViewBag.LoaiVatLieus = new SelectList(_context.VatLieus, "MaVatLieu", "TenVatLieu");
